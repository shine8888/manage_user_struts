		...
		<tr>
			<td align="left" >
				<div style="padding-left:100px;">
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font><s:text name="ADM003.username"></s:text></td>
						<td align="left">
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font> <s:text name="ADM003.groupId"></s:text></td>
						<td align="left">						
							
<%--    <s:if test="#session.listGroup != null">     --%>
<%--     <s:iterator value="#session.listGroup" status="group"> --%>
...
<%-- </s:if> --%>
								...
								<s:select name="groupId"
									...
									list="#attr.groupId" value="groupName"
									listValue="groupName" listKey="groupId">
								</s:select>
						</td>
					</tr>
					<tr>
						<td class="lbl_left"><font color = "red">*</font> <s:text name="ADM003.name"></s:text></td>
						<td align="left">
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font> <s:text name="ADM003.birthday"></s:text></td>
						<td align="left">
						<select>
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font> <s:text name="ADM003.email"></s:text></td>
						<td align="left">
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font><s:text name="ADM003.tel"></s:text></td>
						<td align="left">
					...
					<tr>
						<td class="lbl_left"><font color = "red">*</font><s:text name="ADM003.password"></s:text></td>
						<td align="left">
					...
					<tr>
						<th align="left" colspan = "2" >							
								<a href = "#"><s:text name="ADM003.japaneseAbility"></s:text></a>
						</th>			
					</tr>
					<tr>
					...
					<tr>
						<td class="lbl_left"><s:text name="ADM003.startDate"></s:text> </td>
						<td align="left">
							<select>
									<option value="2000">2000</option>
									<option value="2001">2001</option>
					...
					<tr>
						<td class="lbl_left"><s:text name="ADM003.endDate"></s:text> </td>
						<td align="left">
							<select>
									<option value="2000">2000</option>
									<option value="2001">2001</option>
					...
					<tr>
						<td class="lbl_left"><s:text name="ADM003.score"></s:text> </td>
						<td align="left">
